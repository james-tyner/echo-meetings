<!--
Copy and paste the code from here, don't include it via PHP.
To add or remove the colorband on the left of the card, add or remove that class and leave the card class.
