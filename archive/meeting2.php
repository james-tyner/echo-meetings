...
<main class="meeting-main">
  <section id="agenda">
    ...
    <div class="agenda-item">
      ...
      <h2>Fundraising</h2>
      <p contenteditable="true" class="agenda-item-description">We want to fundraise at least $3,000 to fund this
        project.</p>

      <h3>Notes</h3>
      <p contenteditable="true" class="agenda-item-note">We need to contact different companies who would potentially
        partner with us to fundraise and then come back with different options.</p>
      ...
      <div class="agenda-action-items">
        ...
        <div class="action-item">
          <input type="checkbox">
          <div class="action-item-text">
            <p contenteditable="true" class="action-item-description">Contact Porto's and receive fundraising
              quotes.</p>
            <p contenteditable="true" class="due-date">due Thursday</p>
          </div>
          <div class="assignees">
        ...
        <div class="action-item">
          <input type="checkbox">
          <div class="action-item-text">
            <p contenteditable="true" class="action-item-description">Talk to USG about potential fundraising
              opportunities.</p>
            <p contenteditable="true" class="due-date">due Thursday</p>
          </div>
          <div class="assignees">
    ...
    <div class="agenda-item">
      ...
      <p contenteditable="true" class="agenda-item-description">This year, we will focus our giving project to Red
        Cross. We need a club representative to contact the organization and figure out logistics in donation.</p>
    </div>
    ...
    <div class="agenda-item">
      ...
      <h2>Promote Event</h2>
      <p contenteditable="true" class="agenda-item-note">We want to engage our entire campus, both undergraduate and
        graduate students, to contribute to this giving project. We are looking for donations or engagements from at
        least 2,000 students. So we will need extensive efforts in promoting the event the next month.</p>
    </div>
  </section>
</main>
